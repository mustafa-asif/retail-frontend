...
const BASE_URL = import.meta.env.VITE_API_URL ?? 'https://pos-backend-eight.vercel.app/api';
...
export const storesApi = {
  ...
  getAll: () =>
    request<Store[]>('GET', '/stores'),

  /** GET /stores/:id — Get store by ID */
  getOne: (id: number) =>
    request<Store>('GET', `/stores/${id}`),

  /** POST /stores — Create a new store */
  create: (body: CreateStoreDto) =>
    request<Store>('POST', '/stores', { body }),
...
export const customersApi = {
  ...
  getAll: (pagination?: PaginationParams) =>
    request<PaginatedResponse<Customer>>('GET', '/customers', { query: pagination }),
...
export const salesApi = {
  ...
  getOne: (id: number) =>
    request<Sale>('GET', `/sales/${id}`),

  /** GET /sales/:id/details — Get full sale details (line items etc.) */
  getDetails: (id: number) =>
    request<unknown>('GET', `/sales/${id}/details`),
...
export const inventoryApi = {
  ...
  getAll: () =>
    request<InventoryItem[]>('GET', '/inventory'),
  ...
  getLowStock: () =>
    request<InventoryItem[]>('GET', '/inventory/low-stock'),
...
export const analyticsApi = {
  ...
  getDashboard: () =>
    request<unknown>('GET', '/analytics/dashboard'),

  /** GET /analytics/store-summary — Stats broken down per store */
  getStoreSummary: () =>
    request<unknown>('GET', '/analytics/store-summary'),

  /** GET /analytics/best-selling — Best-selling products */
  getBestSelling: () =>
    request<unknown[]>('GET', '/analytics/best-selling'),

  /** GET /analytics/monthly-sales — Monthly sales totals (chart data) */
  getMonthlySales: () =>
    request<unknown[]>('GET', '/analytics/monthly-sales'),
...
export const auditApi = {
  ...
  getAll: (pagination?: PaginationParams) =>
    request<PaginatedResponse<AuditLog>>('GET', '/audit', { query: pagination }),
  ...
  getByStore: (storeId: number, pagination?: PaginationParams) =>
    request<PaginatedResponse<AuditLog>>('GET', `/audit/store/${storeId}`, { query: pagination }),
};
...
export const fragmentationApi = {
  ...
  getSalesGulshan: () => request<unknown[]>('GET', '/fragmentation/sales/gulshan'),
  /** GET /fragmentation/sales/defense */
  getSalesDefense: () => request<unknown[]>('GET', '/fragmentation/sales/defense'),
  ...
  getInventoryGulshan: () => request<unknown[]>('GET', '/fragmentation/inventory/gulshan'),
  /** GET /fragmentation/inventory/defense */
  getInventoryDefense: () => request<unknown[]>('GET', '/fragmentation/inventory/defense'),
  /** GET /fragmentation/inventory/awami */
  getInventoryAwami: () => request<unknown[]>('GET', '/fragmentation/inventory/awami'),

  // Vertical: Products
  /** GET /fragmentation/products/identity — id, name, category cols */
  getProductsIdentity: () => request<unknown[]>('GET', '/fragmentation/products/identity'),
  /** GET /fragmentation/products/financial — price, cost, margin cols */
  getProductsFinancial: () => request<unknown[]>('GET', '/fragmentation/products/financial'),

  // Vertical: Customers
  /** GET /fragmentation/customers/contact — email, phone cols */
  getCustomersContact: () => request<unknown[]>('GET', '/fragmentation/customers/contact'),
  /** GET /fragmentation/customers/location — address, city cols */
  getCustomersLocation: () => request<unknown[]>('GET', '/fragmentation/customers/location'),
};
...
export const adminApi = {
  ...
  getRoles: () =>
    request<AdminRole[]>('GET', '/admin/roles'),
